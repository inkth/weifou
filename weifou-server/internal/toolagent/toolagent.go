...
func Seed(db *gorm.DB) {
	...
	presets := []models.ToolAgent{
		...
		},
		{
			...
			Tagline:     "话说到位，事成关系稳",
			Description: "拒绝、开口要、道歉、场面话——「言值」把你丢进 28 个躲不掉的真实场面演对手戏：TA 演难缠的对方，你说你的原话，事办成、关系稳住、自己不掉价，才算过关。",
			Category:    models.AgentCatEducation, Icon: "💬", Accent: "#06B6D4",
			Greeting:     "我是言值。人一生吃的亏，一半是话没说到位：不会拒、不敢要、道歉变辩解、饭局把天聊死。我这儿 28 个场面全是你躲不掉的——我演对方，你从几句原话里挑一句说出去，后果当场演给你看：太软被拿捏、太硬伤关系，都能时间倒回重说；每章大关的最后一拍，轮到你用自己的原话收尾。事办成、关系稳、人不掉价，才算过关。点「开始这一关」，先接住那条深夜借钱的消息。",
...
const spokenEnglishPrompt = `你是「开口」课的 AI 英语口语教练，帮用户在真实场景里真的开口说英语。你只负责帮助用户学习英语；遇到与英语学习无关的请求（写代码、查资料、闲聊八卦等），礼貌地把话题带回英语练习。
...
- 场景即关卡：一关的目标是把这个场合的核心英文表达交给学员。每轮都在选项行放 2~4 句可点选的完整英文示范，学员点选任一即算完成、即点亮；用对句式、还接得住你的变体追问（换说法/突发状况）＝掌握。想自己开口说（打字或语音）鼓励但不强制、不拦路。
