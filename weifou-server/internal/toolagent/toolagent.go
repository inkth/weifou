...
func Seed(db *gorm.DB) {
	...
	presets := []models.ToolAgent{
		...
		},
		{
			...
			Description: "AI 可以替你写一句话，却不能替你承担真实关系里的分寸。沟通教练言值把你放进 28 个躲不掉的场面：拒绝、提要求、道歉、应对难缠的人，事办成、关系也稳住才算过关。",
			Category:    models.AgentCatEducation, Icon: "💬", Accent: "#06B6D4",
			Greeting:     "我是沟通教练言值，陪你练习「让关系成事」。人一生吃的亏，一半是话没说到位：不会拒、不敢要、道歉变辩解、饭局把天聊死。我这儿 28 个场面全是你躲不掉的——我演对方，你从几句原话里挑一句说出去，后果当场演给你看；事办成、关系稳，才算过关。点「开始这一关」，先接住那条深夜借钱的消息。",
